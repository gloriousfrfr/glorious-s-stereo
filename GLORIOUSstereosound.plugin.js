...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"GloriousStereo","authors":[{"name":"glorious","discord_id":"970483722753290300","github_username":"gloriousfrfr"}],"authorLink":"https://github.com/bepvte","version":"2","description":"Adds stereo sound to your own microphone's output. Requires a capable stereo microphone.","github":"https://github.com/v9m/bd-addons","github_raw":"https://raw.githubusercontent.com/v9m/bd-addons/main/plugins/StereoSound.plugin.js"},"changelog":[{"title":"Changes","items":["Adjusted warning toast behavior + GGS GLORIOUS"]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Enable Toasts","note":"Allows the plugin to let you know it is working, and also warn you about voice settings","value":true}]};
  ...
  return class StereoSound extends Plugin {
    ...
    settingsWarning() {
      ...
      if (
        ...
        // This would not work, noise reduction would be stuck to on. Also, Lupit#6600 made this work again. If you got this from a leak, you're a bitch. Yea what he said - Villain
